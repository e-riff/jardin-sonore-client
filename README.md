...
- les variables du portail dans `.env.deploy.local`: `CPANEL_PORTAL_PUBLIC_URL`, `CPANEL_PORTAL_API_BASE_URL` et `CPANEL_PORTAL_BFF_SHARED_SECRET` (ces deux dernières restent exclusivement côté serveur);
