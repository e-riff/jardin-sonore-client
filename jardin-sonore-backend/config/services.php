...
use App\Infrastructure\Doctrine\Repository\InstrumentDoctrineRepository;
use App\Infrastructure\Doctrine\Repository\InstrumentTagDoctrineRepository;
...
return static function (ContainerConfigurator $containerConfigurator): void {
    ...
    $services->alias(InstrumentRepositoryInterface::class, InstrumentDoctrineRepository::class);
    $services->alias(InstrumentTagRepositoryInterface::class, InstrumentTagDoctrineRepository::class);
