...
return static function (ClassMetadata $metadata): void {
    ...
    $metadata->mapManyToMany(['fieldName' => 'themes', 'targetEntity' => ThemeEntity::class, 'joinTable' => ['name' => 'media_resource_theme', 'joinColumns' => [['name' => 'media_resource_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE']], 'inverseJoinColumns' => [['name' => 'theme_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE']]]]);
};
