...
const {parsePortalListQuery, portalListQueryToSearchParams, updatePortalListQuery} = await import(`data:text/javascript;base64,${Buffer.from(javascript).toString("base64")}`);
