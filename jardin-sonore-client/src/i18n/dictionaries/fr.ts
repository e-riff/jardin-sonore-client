const fr = {
    ...
    footer: {
        ...
        links: [
            {label: "Espace structures", href: "/portail/connexion"},
            {label: "Intervenant", href: "#intervenant-musical"},
            {label: "Formats", href: "#formats"},
            {label: "Approche", href: "#approche"},
            {label: "En séance", href: "#en-seance"},
    ...
    portal: {
        login: {
            eyebrow: "Espace structures",
            title: "Accéder à vos séances",
            description: "Connectez-vous pour consulter les séances partagées avec votre structure.",
            emailLabel: "Adresse e-mail",
            passwordLabel: "Mot de passe",
            submit: "Se connecter",
            submitting: "Connexion en cours…",
            error: "La connexion n’a pas pu être établie. Vérifiez vos identifiants et réessayez.",
            resetLink: "Mot de passe oublié ?",
        },
        reset: {
            eyebrow: "Espace structures",
            title: "Réinitialiser votre mot de passe",
            description: "Indiquez votre adresse e-mail pour recevoir un lien de réinitialisation.",
            emailLabel: "Adresse e-mail",
            submit: "Envoyer le lien",
            submitting: "Envoi en cours…",
            confirmation: "Si cette adresse est associée à un compte, un lien de réinitialisation vient de vous être envoyé.",
            error: "La demande n’a pas pu être envoyée pour le moment. Merci de réessayer.",
            loginLink: "Revenir à la connexion",
        },
        password: {
            eyebrow: "Espace structures",
            title: "Définir votre mot de passe",
            description: "Choisissez un mot de passe pour accéder à vos séances.",
            passwordLabel: "Nouveau mot de passe",
            hint: "Utilisez au moins 12 caractères.",
            submit: "Enregistrer et accéder aux séances",
            submitting: "Enregistrement en cours…",
            error: "Le mot de passe n’a pas pu être enregistré. Merci de réessayer.",
            unavailable: "Ce lien n’est plus disponible. Demandez un nouveau lien de réinitialisation à votre administrateur ou depuis la page de connexion.",
        },
        shell: {
            homeAriaLabel: "Espace structures Jardin Sonore",
            logout: "Se déconnecter",
        },
        unavailable: {
            eyebrow: "Espace structures",
            title: "Service momentanément indisponible",
            description: "Nous ne pouvons pas joindre vos séances pour le moment. Merci de réessayer dans quelques instants.",
            loginLink: "Revenir à la connexion",
        },
    },
} as const;
