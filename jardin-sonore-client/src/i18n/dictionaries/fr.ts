const fr = {
    ...
    hero: {
        ...
        serviceArea: "Forez — Gier — Pilat — Lyonnais",
    ...
    exploration: {
        ...
        testimonialsDescription: "Les mots des professionnel·le·s qui accueillent ces ateliers au fil de l'année.",
        photoGroups: [
            {
                title: "En séance",
    ...
    testimonials: {
        title: "Témoignages",
        description: "Ce que disent les professionnelles et professionnels des structures partenaires.",
        quoteMark: "“",
        items: [
            {
    ...
    portal: {
        ...
        filters: {searchLabel: "Rechercher", searchAction: "Rechercher", organizationLabel: "Structure", allOrganizations: "Toutes les structures", typeLabel: "Type de contenu", allTypes: "Tous les types", nurseryRhyme: "Comptines", fingerplay: "Jeux de doigts", sortLabel: "Trier par", sortDate: "Date de séance", sortUpdatedAt: "Dernière mise à jour", sortTitle: "Titre", sortDateShort: "Date", sortTitleShort: "A-Z", directionLabel: "Ordre", ascending: "Croissant", descending: "Décroissant", categoriesLabel: "Catégories", noCategories: "Aucune catégorie disponible pour ces contenus", showAllCategories: "Voir toutes les catégories", showFewerCategories: "Réduire les catégories", reset: "Effacer les filtres", previousPage: "Page précédente", nextPage: "Page suivante", pageStatus: "Page"},
        sessions: {title: "Vos séances", introduction: "Retrouvez les séances partagées avec votre structure.", sharedAt: "Partagée le", empty: "Aucune séance ne correspond à ces critères."},
        repertoire: {title: "Comptines et jeux de doigts", introduction: "Retrouvez les contenus utilisés dans les séances partagées avec votre structure.", empty: "Aucune comptine ou jeu de doigts ne correspond à ces critères.", updatedAt: "Mis à jour le", source: "Source", lyrics: "Paroles", gestures: "Gestes", instructions: "Indications", media: "Médias", notes: "Notes", back: "Retour", externalLink: "Ouvrir le média", openFile: "Ouvrir ou télécharger le fichier", playHere: "Lire ici", audioUnavailable: "Cet audio ne peut pas être lu dans ce navigateur.", videoUnavailable: "Cette vidéo ne peut pas être lue dans ce navigateur.", audioLabel: "Audio", videoLabel: "Vidéo", fileLabel: "Fichier", linkLabel: "Lien", organizations: "Structures"},
        detail: {back: "Retour", downloadPdf: "PDF", downloadPdfAriaLabel: "Télécharger le PDF", pdfPreparing: "PDF en préparation", pdfUnavailable: "PDF indisponible", intention: "Intention de séance", material: "Instruments et matériel", instruments: "Instruments utilisés", sequence: "Déroulé", exploration: "Pour aller plus loin"},
        account: {eyebrow: "Mon compte", title: "Vos informations", description: "Personnalisez le nom et la photo affichés dans votre espace.", saved: "Vos informations ont été enregistrées.", error: "Vos informations n’ont pas pu être enregistrées. Vérifiez le format de votre photo.", saving: "Enregistrement…", emailLabel: "Adresse e-mail", organizationSingle: "Votre structure", organizationPlural: "Vos structures", currentPhoto: "Photo actuelle", currentPhotoAlt: "Votre photo de profil", photoLabel: "Photo de profil", optional: "facultatif", photoHint: "JPEG, PNG ou WebP — 2 Mo maximum.", photoTooLarge: "Cette image dépasse 2 Mo. Choisissez un fichier plus léger.", photoInvalid: "Choisissez une image JPEG, PNG ou WebP de 2 Mo maximum.", firstNameLabel: "Prénom", lastNameLabel: "Nom", notificationsTitle: "M’informer des nouvelles séances", notificationsDescription: "Recevez un e-mail lorsqu’une nouvelle séance devient disponible pour votre structure.", submit: "Enregistrer"},
        preview: {title: "Déroulé", resourceFallback: "Ressource associée", lyricsAndGestures: "Paroles et gestes", sequenceFallback: "Séquence", types: {warmup: "Mise en route", nursery_rhyme: "Comptine", fingerplay: "Jeu de doigts", soundtrack: "Bande-son", manipulation: "Manipulation", movement: "Mouvement", closing: "Clôture", free: "Activité libre"}},
        ...
        error: {eyebrow: "Espace structures", title: "Une erreur est survenue", description: "Cette page ne peut pas être affichée pour le moment. Vous pouvez réessayer ou revenir à vos séances.", retry: "Réessayer", sessionsLink: "Retour aux séances"},
