        ...
        <section className="relative overflow-hidden" id="top">
            <div className="relative flex min-h-screen items-center">
                ...
                <div className="relative z-10 mx-auto flex w-full max-w-330 items-center justify-center px-5 pb-24 pt-28 sm:px-8 sm:pt-32 lg:px-12 lg:pb-28 lg:pt-36">
                    <div className="w-full max-w-195 rounded-xl border border-white/60 bg-surface/82 px-7 py-10 text-center backdrop-blur-xl ambient-shadow sm:px-10 sm:py-12 md:px-14 md:py-16">
                        ...
                        <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:mt-10 sm:flex-row">
                            <Button className="min-w-47.5" href="#about">{content.primaryCta}</Button>
