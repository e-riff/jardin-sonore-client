...
export default function PortalRepertoireList({account, accountLabel, content, filters, response, query}: {account: PortalAccount; accountLabel: string; content: Dictionary["portal"]["repertoire"]; filters: Dictionary["portal"]["filters"]; response: PortalRepertoireListResponse; query: PortalListQuery}): React.JSX.Element {
