...
export default async function CtaSection(): Promise<JSX.Element> {
    ...
    return (
        <section className="px-6 pb-xl sm:px-margin" id={"contact"}>
            <div className="relative mx-auto max-w-7xl overflow-hidden rounded-xl border border-outline-variant/20 bg-surface-container px-8 py-16 text-center soft-shadow sm:px-16 md:px-24 md:py-24">
