...
export default async function PortalResetPage({searchParams}: {searchParams: Promise<{sent?: string}>}): Promise<React.JSX.Element> {
    ...
    return <PortalAccountProvider account={account}><div className="portal-shell"><PortalAccountHeader onLogout={logoutPortalAction} /><main className="flex min-h-[calc(100vh-4.5rem)] items-center justify-center px-4 py-16">{panel}</main></div></PortalAccountProvider>;
}
