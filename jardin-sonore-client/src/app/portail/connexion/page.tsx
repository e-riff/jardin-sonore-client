    ...
    return (
        <section className="mx-auto flex min-h-[70vh] max-w-lg items-center px-6 py-24 sm:px-margin">
            <div className="w-full rounded-3xl border border-outline-variant/50 bg-surface-container-lowest p-7 ambient-shadow sm:p-10">
                ...
                <div className="mt-8"><PortalLoginForm /></div>
                <a className="mt-6 inline-block font-sans text-sm font-bold text-primary underline underline-offset-4" href="/portail/reinitialiser-mot-de-passe">{content.resetLink}</a>
            </div>
        </section>
    );
}
