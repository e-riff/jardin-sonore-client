...
.PHONY: help docker docker-build docker-up docker-down docker-restart clean \
	print-urls lint app-build deploy deploy-client deploy-backend setup-backend-local-host npm exec-npm \
...
help:
	...
	@printf "  make deploy                Deploie backend puis front en une seule commande\n"
